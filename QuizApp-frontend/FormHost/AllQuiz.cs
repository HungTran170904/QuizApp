...
namespace QuizApp_frontend.FormHost
{
    public partial class AllQuiz : Form
    {
        ...
        public AllQuiz(List<Quiz> quizzes, Action<Form, bool> switchChildForm)
        {
            InitializeComponent();
            this.quizzes = quizzes;
            this.switchChildForm = switchChildForm;
            addButtonFromQuizzes();
        }
        ...
        {
            Form1 form1 = new Form1(quizzes,this,switchChildForm);
            switchChildForm(form1, true);
        }
    }
}
